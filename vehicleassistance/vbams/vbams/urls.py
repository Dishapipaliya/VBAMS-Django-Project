...
urlpatterns = [
    ...
    #Vehicle
    path('Admin/add-vehicle/', adminviews.add_vehicle, name='add_vehicle'),
    path('Admin/ManageVehicle', adminviews.MANAGEVEHICLE, name='manage_vehicle'),
    path('Admin/DeleteVehicle/<str:id>', adminviews.DELETE_VEHICLE, name='delete_vehicle'),
    path('Admin/UpdateVehicle/<str:id>', adminviews.UPDATE_VEHICLE, name='update_vehicle'),
    path('Admin/UPDATE_Vehicle_DETAILS', adminviews.UPDATE_VEHICLE_DETAILS, name='update_vehicle_details'),
    

    path('Admin/NewVehicleRequest', adminviews.NEWVEHICLEREQUEST, name='new_vehicle_request'),
    path('Admin/ApprovedVehicleRequest', adminviews.APPROVEDVEHICLEREQUEST, name='approved_vehicle_request'),
    # path('Admin/RejectedVehicleRequest', adminviews.REJECTEDVEHICLEREQUEST, name='rejected_vehicle_request'),
    # path('Admin/AllVehicleRequest', adminviews.ALLVEHICLEREQUEST, name='all_vehicle_request'),
    path('Admin/UpdatevehicleRequest/<str:id>', adminviews.UPDATE_REQUEST, name='update_vehicle_request'),
...
# Driver Panel
 ...
 path('Driver/SearchBooking', driverviews.Search_Booking, name='search_booking'),
  ...
  #vehicle panel
  path('VehicleProfile', driverviews.VEHICLE_PROFILE, name='vehicle-profile'),
